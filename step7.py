...
while gameOver == False:
    ...
    #PLATFORM COLLISION
    if xpos + 20 > 100 and xpos < 200 and ypos + 20 > 350 and ypos + 20 < 370:
        ypos = 350 -20
        isOnGround = True
        vy = 0
    elif xpos + 20 > 200 and xpos < 300 and ypos + 20 > 450 and ypos + 20 < 470:
        ypos = 450 - 20
        isOnGround = True
        vy = 0
    else:
    ...
    #first platform
    pygame.draw.rect(screen, (200, 0, 100), (100, 350, 100, 20))
    
    #second platform
    pygame.draw.rect(screen, (100, 0, 200), (200, 450, 100, 20))
